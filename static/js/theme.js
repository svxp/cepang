(function($) {
    'use strict';
			...
			/*==== One Page Nav  ====*/
			  ...
			  $(".one_page .teesta_menu .nav_scroll").onePageNav({ currentClass: "current", changeHash: !1, scrollSpeed: 1000, scrollOffset: top_offset, scrollThreshold: 0.5, filter: "", easing: "swing" });
			...
			/*==== about slider active ====*/
			var witrbslick = $('.abslider_active');
